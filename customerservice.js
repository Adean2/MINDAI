...
loader.load("Customer_Temporal.glb", (gltf) => {
  ...
  brain.traverse((child) => {
    if (child.isMesh && child.name === "Current") {
      child.userData = {
        description:
          "AI-powered customer service has already made significant inroads into the industry,",
      };
      child.userData.imageURL = "C3.jpeg";
      child.userData.nameobject = "Current state of AI Customer Service";
      child.userData.braindescript =
        "Businesses of all sizes are adopting chatbots and virtual assistants to provide support to their customers.";
      child.userData.braindescript1 =
        "Technologies can handle a wide range of tasks, from answering frequently asked questions to processing returns and refunds. ";
    }
    if (child.isMesh && child.name === "Potential") {
      child.userData = {
        description:
          "AI has the potential to significantly improve the customer service experience for businesses and consumers alike.",
      };
      child.userData.imageURL = "C2.webp";
      child.userData.nameobject = "Potential benefits of AI Customer Service";
      child.userData.braindescript =
        "Chatbots and virtual assistants can provide instant support, 24/7, reducing response times and improving customer satisfaction.";
      child.userData.braindescript1 =
        "AI can help to reduce the workload on customer service agents, freeing them up to handle more complex requests and improving overall efficiency.";
    }
    if (child.isMesh && child.name === "Ethical") {
      child.userData = {
        description:
          "While AI in customer service has the potential to bring significant benefits, it also poses ethical and social challenges that must be addressed. ",
      };
      child.userData.imageURL = "C4.jpeg";
      child.userData.nameobject = "Ethical and social implications";
      child.userData.braindescript =
        "AI-powered chatbots and virtual assistants could replace human workers, leading to job loss and economic inequality";
      child.userData.braindescript1 = "";
    }
    if (child.isMesh && child.name === "Case") {
      child.userData = {
        description:
          "There are already many examples of AI being used in customer service, with promising results.",
      };
      ...
      child.userData.braindescript1 =
        "virtual assistants can improve customer satisfaction ratings by up to 35%";
    }
