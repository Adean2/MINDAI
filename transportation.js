...
loader.load("Transportation_Cerebellum.glb", (gltf) => {
  ...
  brain.traverse((child) => {
    if (child.isMesh && child.name === "Curren") {
      child.userData = {
        description:
          "AI is already being used in transportation in various ways, such as self-driving cars that rely on machine learning algorithms to navigate roads and optimize routes.",
      };
      child.userData.imageURL = "Education_Current.jpeg";
      child.userData.nameobject = "Current stat";
    ...
    if (child.isMesh && child.name === "Potentia") {
      child.userData = {
        description:
          "AI has the potential to significantly improve the transportation sector, providing safer, more efficient, and more sustainable modes of transportation.",
      };
      child.userData.imageURL = "Education_Potential.jpeg";
      child.userData.nameobject = "Potential benefits";
      child.userData.braindescript =
        "Self-driving cars could reduce accidents caused by human error, while predictive maintenance systems could prevent breakdowns and reduce the need for costly repairs. ";
      child.userData.braindescript1 =
        "traffic management tools could help to reduce congestion and improve the overall efficiency of transportation networks.";
    }
    if (child.isMesh && child.name === "Ethica") {
      child.userData = {
        description:
          "While AI transportation has the potential to bring significant benefits, it also poses ethical and social challenges that must be addressed.",
      };
    ...
    if (child.isMesh && child.name === "Cas") {
      child.userData = {
        description:
          "There are already many examples of AI being used in transportation, with promising results.",
      };
      ...
      child.userData.braindescript1 =
        "AI-powered traffic management systems could reduce travel times by up to 26%";
    }
...
function onPointerMove(event) {
  ...
  if (intersects.length > 0) {
    ...
    modelDescElement.textContent =
      "The cerebellum is a critical part of the human brain responsible for motor coordination and balance. In the context of AI transportation, the cerebellum can be linked to the development of advanced autonomous vehicle technologies that use machine learning algorithms to navigate complex road environments and ensure passenger safety. Similar to how the cerebellum coordinates motor movements and maintains balance, AI-powered transportation technologies can monitor and adjust to road conditions, traffic patterns, and other external factors to ensure smooth and efficient travel.";

    modelImageElement.src = "Transportation.jpeg";
