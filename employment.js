...
loader.load("Employment_Limbic.glb", (gltf) => {
  brain = gltf.scene;
  ...
  t1.fromTo(brain.scale, { z: 0, x: 0, y: 0 }, { z: 1.5, x: 1.5, y: 1.5 });
  ...
  brain.traverse((child) => {
    if (child.isMesh && child.name === "Current") {
      child.userData = {
        description:
          "Currently the field of AI in education is still in its early stages.",
      };
    ...
    if (child.isMesh && child.name === "Potential") {
      ...
      child.userData.braindescript =
        "Learning outcomes can be improved by providing timely and targeted feedback to students, enabling educators to focus attention on areas where students need help.";
      child.userData.braindescript1 =
...
function onPointerMove(event) {
  ...
  if (intersects.length > 0) {
    ...
    modelDescElement.textContent =
      "The nucleus is a critical part of the human brain responsible for regulating basic physiological functions such as sleep and appetite. In the context of AI government, the nucleus can be linked to the development of advanced governance technologies that use machine learning algorithms to analyze and predict social and economic trends, enabling more effective policy-making and resource allocation.";
